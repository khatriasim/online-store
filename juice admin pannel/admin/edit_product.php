...
if(isset($_POST['update'])) {
   ...
   $old_image = isset($_POST['old image']) ? $_POST['old image'] : '';
...
<head>
    ...
    <title>fresho admin-edit product page</title>
</head>
<body>
                ...
                <div class="form-container">
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="input-field">
                          ...
                          <img src="../image/<?= $fetch_product['image']; ?>" class="product_image">
                    </div>
                        <div class="flex_btn">
                        <button type="submit" name="update" class="btn small">update product</button>
                       <a href="view_product.php" class="btn">go back</a>

                       <button type="submit" name="delete" class="btn small">delete product</button>
                        </div>
                   </form>
                </div>
              <?php
