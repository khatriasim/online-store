...
if (isset($_POST['update_cart'])) {
    ...
    $success_msg[] = 'cart quantity updated sucessfully';
}
if (isset($_POST['delete_item'])){
    ...
    if($verify_delete_items->rowCount()>0) {
        ...
        $success_msg[] = "cart item delete sucessfully";
    }else{
...
<form method="post" action="" class="box">
    ...
    <div class="flex">
        ...
        <div class="qty-container"> <!-- Add a div container for qty and button -->
    ...
    <p class="sub-total">sub total : <span>Rs:<?= $sub_total ?></span></p>
